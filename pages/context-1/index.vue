...
.context .header .img-settings-close {
  position: fixed;
  top: 20px;
  right: 20px;
  z-index: 13;
...
.context .body .titles h1 {
  font-weight: 700;
  font-size: 36px;
  line-height: 45.25px;
}

.context .body .titles h2 {
  font-family: "Bayon";
  font-size: 24px;
  font-weight: 400px;
}
